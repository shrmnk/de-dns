...
ActiveRecord::Schema.define(version: 2019_03_27_143333) do
  ...
  create_table "cloudflare_accounts", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_cloudflare_accounts_on_email", unique: true
  ...
  create_table "zones", force: :cascade do |t|
    ...
    t.index ["identifier"], name: "index_zones_on_identifier", unique: true
